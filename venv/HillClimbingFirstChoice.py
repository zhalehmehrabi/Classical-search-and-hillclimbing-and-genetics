...
def hillClimbingFirstChoise(colorHill, graphHill, nodeNum):
    queue = []
    extendSize = 0
    visitSize = 1
...
if __name__ == "__main__":
    ...
    extend, visit, storage = hillClimbingFirstChoise(color, graph, numberOfNodes)
