...
graph = {
    ...
    'sibiu': ['Rimnicu', 'Arad', 'fagaras', 'Oradea'],  # age rimcu o oradea ro ja b ja knim b javab mirese
...
if __name__ == "__main__":
    path, extend, visit, storage = dfsGraph(graph, 'Arad', 'Bucharest')
